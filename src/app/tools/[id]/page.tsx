                  ...
                  >
                    ...
                    {tool.promoCode && (
                      <p className="mt-3 text-sm text-white/80">
                        Use code <span className="font-mono font-bold bg-white/20 px-2 py-0.5 rounded">{tool.promoCode}</span> for 15% off
                      </p>
                    )}
                  </a>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      {tool.detailedContent.pricingPlans.map((plan, i) => (
                        ...
                        >
                          ...
                          {tool.promoCode && plan.highlight && (
                            <p className="text-center mt-2 text-xs text-cyan-400">
                              Code <span className="font-mono font-bold">{tool.promoCode}</span> for 15% off
                            </p>
                          )}
                        </div>
                      ))}
                    ...
                    <div className="mt-6 pt-6 border-t border-slate-700/50">
                      ...
                      {tool.promoCode && (
                        <p className="mt-3 text-sm text-slate-400">
                          Use code <span className="font-mono font-bold text-amber-400 bg-amber-500/10 px-2 py-0.5 rounded">{tool.promoCode}</span> for 15% off
                        </p>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="bg-gradient-to-r from-slate-800 to-slate-800/50 rounded-2xl p-8 border border-slate-700/50 text-center">
                    ...
                    {tool.promoCode && (
                      <p className="mt-4 text-sm text-slate-400">
                        Use code <span className="font-mono font-bold text-cyan-400 bg-cyan-500/10 px-2 py-0.5 rounded">{tool.promoCode}</span> for 15% off at checkout
                      </p>
                    )}
                  </div>
                </>
              ...
              <div className="bg-slate-800/50 rounded-2xl p-6 border border-slate-700/50 sticky top-4">
                ...
                {tool.promoCode && (
                  <div className="mt-3 text-center">
                    ...
                    <span className="font-mono text-sm font-bold text-cyan-400 bg-cyan-500/10 px-2 py-0.5 rounded">{tool.promoCode}</span>
                    <span className="text-xs text-slate-400"> for 15% off</span>
                  </div>
                )}
